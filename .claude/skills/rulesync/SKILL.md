...
name: rulesync
description: >-
  プロジェクトのプロンプト・ルールを更新するためのツール。ユーザーの指示を誤って実行したり、ユーザーの傾向やプロジェクトの習慣を把握できていないことに気づいた場合、または自分自身のプロンプトを改善したい場合に使用する。.rulesync/
  ディレクトリ配下のルールファイルを編集し、各AIツール（Claude、Copilot、Agents）に同期する。
---
# Rulesync プロンプト管理
